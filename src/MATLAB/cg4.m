...
%   
% Inputs:
%   odefun: handle to 2nd-order ODE function that computes dVbdt (time derivative
...
function [t_new,Twb_new,Vb_new] = cg4(odefun,dt,t,Twb,Vb,Fb,params)
...
for i = 1:s
    ...
    K_tmp{i} = feval(odefun,t + c(i)*dt,Twb_tmp{i},Vb_tmp{i},Fb,params);
end
