...
%   Vb:  body twist, represented by a 6x1 vector, i.e., an element of se(3)
%   Fb:  net external body wrench, represented by a 6x1 vector, i.e., an
%        element of dse(3), the dual space to se(3).
